...
async def handle_main_menu_callbacks(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "adm_menu_main":
        ...
        try:
            ...
            await query.edit_message_text("❌ Error loading statistics module.", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("⬅️ Back", callback_data="adm_menu_main")]]))
        finally:
            db.close()